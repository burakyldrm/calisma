...
def tr_stopwords():
    ...
    stopwords = ["a", "acaba", "altı", "ama", "ancak", "artık", "asla", "aslında", "az", "b", 
                 ...
                 "onların", "onların", "onu", "onun", "orada", "oysa", "oysaki", "ö", "öbürü", "ön", "önce", 
                 ...
                 "şunun", "t", "tabi", "tamam", "tüm", "tümü", "u", "ü", "üç", "üzere", "v", "var", "ve", "veya",
                 "veyahut", "y", "ya", "ya da", "yani", "yedi", "yerine", "yine", "yoksa", "z", "zaten", "zira"]
