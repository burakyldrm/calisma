...
import sys
sys.path.append('/code/django_docker/learning/language_tools')
import polyglot_NER, spellchecker, TokenHandler
...
def category_stats(instances, labels, outputfolderpath, lang):
