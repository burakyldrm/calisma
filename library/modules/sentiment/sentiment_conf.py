...
tr_twitter_sentiment_PREP_params = {
    stopword_key : True,
    more_stopwords_key : None,    # twitter specific stopwords! we shouldn't remove çok, ama vs.
    spellcheck_key : False ,
    stemming_key : True,
...
tr_twitter_sentiment_params = {
    ...
    feat_params_key : {
        ...
        weights_key : {"word_tfidf" : 1,
                           ...
                           "lexicon_count" : 1,
                           "char_tfidf" : 1},
        prep_key : tr_twitter_sentiment_PREP_params,
        },
