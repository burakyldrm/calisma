...
def fix_yildiz_corpora():
    ...
    print("Reading")
    folder = "/home/dicle/Documents/data/tr/kemik/text_collection/new_fixed"
...
if __name__ == '__main__':
    ...
    # fix_lexicon()
    '''
    fix_texts_nested(infolder = "/home/dicle/Documents/data/tr_sentiment/sentiment-3000tweet/enhanced_data/orig",
    outfolder = "/home/dicle/Documents/data/tr_sentiment/sentiment-3000tweet/enhanced_data/fixed")
    '''
    
    '''
    fix_texts_nested(infolder="/home/dicle/Documents/data/tr_spam/TurkishEmail/fix", 
                     outfolder="/home/dicle/Documents/data/tr_spam/TurkishEmail/char-fixed2")
    
    '''
    fix_texts_nested(infolder="/home/dicle/Documents/data/tr_plain_texts/1150haber/raw_texts", 
                     outfolder="/home/dicle/Documents/data/tr_plain_texts/1150haber/charfixed")
