...
if __name__ == '__main__':
    text = "WASHINGTON -- In the wake of a string of abuses by New York City police officer \
    A. Steven Bird in the 1990s, Loretta E. Lynch, the top federal prosecutor in Brooklyn, \
    spoke forcefully about the pain of a broken trust that African-Americans felt and said \
    the responsibility for repairing generations of miscommunication and mistrust fell to law enforcement in May. \
    Then John met Mary at the Big Garden."
    #text = text.upper()
